...
app.use(cors({
    origin: ['http://localhost:5173', 'http://localhost:5174', 'https://dako23.web.app', 'https://new-style-garden.web.app', 'https://newstylegarden.com', 'https://megasys.megaparts.bg/megasys/product','https://megasys.megaparts.bg'],
    credentials: true,
    allowedHeaders: ["Content-Type", "Authorization"],
    exposedHeaders: ['Set-Cookie']
}));
